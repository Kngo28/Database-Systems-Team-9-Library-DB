...
export default function AdminPage() {
  ...
  const myAccountCards = [
    { title: "Catalog", description: "Browse and borrow library items.", icon: catalogueIcon, path: "/catalog" },
  ...
  const adminToolCards = [
    ...
    { title: "Manage Staff", description: "Register and manage staff accounts.", icon: staffIcon, path: "/manage-staff" },
    { title: "Manage Rooms", description: "Add rooms and control availability.", icon: manageRoomIcon, path: "/manage-rooms" },
    { title: "Reports", description: "View system reports and analytics.", icon: reportIcon, path: "/reports" },
  ];
